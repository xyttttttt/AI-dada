...
import com.xyt.dada.cache.CaffeineCache;
import com.xyt.dada.manager.AiManager;
import com.xyt.dada.model.dto.question.QuestionAnswerDTO;
...
public class AiTestScoringStrategy implements ScoringStrategy {
    ...
    public UserAnswer doScore(List<String> choice, App app) throws Exception {
        ...
        String cacheKey = CaffeineCache.buildCacheKey(appId, jsonStr);

        String answerJson = CaffeineCache.answerCacheMap.getIfPresent(cacheKey);
        ...
        //缓存结果
        CaffeineCache.buildAnswerCache(cacheKey, json);
        // 3. 构造返回值，填充答案对象的属性
