...
import com.xyt.dada.model.dto.app.AppAddRequest;
import com.xyt.dada.model.dto.app.AppEditRequest;
import com.xyt.dada.model.dto.app.AppQueryRequest;
import com.xyt.dada.model.dto.app.AppUpdateRequest;
import com.xyt.dada.model.dto.review.ReviewRequest;
import com.xyt.dada.model.entity.App;
import com.xyt.dada.model.entity.User;
import com.xyt.dada.model.enums.ReviewStatusEnum;
import com.xyt.dada.model.vo.AppVO;
...
public class AppController {
    ...
    public BaseResponse<Long> addApp(@RequestBody AppAddRequest appAddRequest, HttpServletRequest request) {
        ...
        app.setReviewStatus(Integer.valueOf(ReviewStatusEnum.UNREVIEWED.getValue()));
        // 数据校验
    ...
    public BaseResponse<Page<AppVO>> listAppVOByPage(@RequestBody AppQueryRequest appQueryRequest,
        ...
        //只能看到已审核通过的数据
        appQueryRequest.setReviewStatus(Integer.valueOf(ReviewStatusEnum.PASS.getValue()));
        // 查询数据库
        Page<App> appPage = appService.page(new Page<>(current, size),
                appService.getQueryWrapper(appQueryRequest));
        // 获取封装类
    ...
    @PostMapping("/review")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> addDoReview(@RequestBody ReviewRequest reviewRequest,HttpServletRequest httpServletRequest){
        ThrowUtils.throwIf(reviewRequest == null, ErrorCode.PARAMS_ERROR);
        Long id = reviewRequest.getId();
        Integer reviewStatus = reviewRequest.getReviewStatus();
        String reviewMessage = reviewRequest.getReviewMessage();
        ReviewStatusEnum reviewStatusEnum = ReviewStatusEnum.getEnumByValue(String.valueOf(reviewStatus));
        ...
        if (oldApp.getReviewStatus().equals(reviewStatus)){
            throw new BusinessException(ErrorCode.PARAMS_ERROR,"当前状态不可重复审核");
        }
        userService.getLoginUser(httpServletRequest);
        App app = new App();
        app.setId(id);
        app.setReviewStatus(reviewStatus);
        app.setReviewerId(userService.getLoginUser(httpServletRequest).getId());
