...
import com.xyt.dada.model.dto.userAnswer.UserAnswerAddRequest;
import com.xyt.dada.model.dto.userAnswer.UserAnswerEditRequest;
import com.xyt.dada.model.dto.userAnswer.UserAnswerQueryRequest;
import com.xyt.dada.model.dto.userAnswer.UserAnswerUpdateRequest;
...
public class UserAnswerController {
    ...
    public BaseResponse<Long> addUserAnswer(@RequestBody UserAnswerAddRequest userAnswerAddRequest, HttpServletRequest request) {
        ...
        if (!Objects.equals(ReviewStatusEnum.getEnumByValue(String.valueOf(app.getReviewStatus())), ReviewStatusEnum.PASS)){
            throw new BusinessException(ErrorCode.OPERATION_ERROR,"应用未过审，无法答题");
        }
